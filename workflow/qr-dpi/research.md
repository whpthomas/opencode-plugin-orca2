...
Conduct comprehensive research across the codebase to answer user questions. Analyze the codebase thoroughly by exploring relevant modules, components and data flow.
...
- Analyze and decompose the research questions
